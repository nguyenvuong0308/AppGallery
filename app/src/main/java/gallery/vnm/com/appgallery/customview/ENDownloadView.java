...
public class ENDownloadView extends View {
    ...
    public void start() {
        ...
        preAnim.addUpdateListener(valueAnimator -> {
    ...
    private void downloadAnim() {
        ...
        downloadAnim.addUpdateListener(valueAnimator -> {
            mFraction = valueAnimator.getAnimatedFraction();
    ...
    public void end() {
        ...
        endAnim.setDuration(0);
        endAnim.setInterpolator(new OvershootInterpolator());
        endAnim.addUpdateListener(valueAnimator -> {
            mFraction = valueAnimator.getAnimatedFraction();
            invalidate();
        });
    ...
    public void reset() {
        ...
        resetAnim.addUpdateListener(valueAnimator -> {
            mFraction = valueAnimator.getAnimatedFraction();
            invalidate();
        });
